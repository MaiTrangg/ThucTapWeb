    ...
    <div class="container-scroller">
     ...
     <c:import url="includes_ad/navbar.jsp"></c:import>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <c:set var="currentPage" value="index_ad" />
                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h5 class="mb-2 text-dark font-weight-normal">Total Sales </h5>
                            <h2 class="mb-4 text-dark font-weight-bold">${total }</h2>
                             <div class="dashboard-progress dashboard-progress-1 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-book icon-md absolute-center text-dark"></i>
                             </div>
                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            ...
                            <h2 class="mb-4 text-dark font-weight-bold"> ${prosale } </h2>
                            <div class="dashboard-progress dashboard-progress-2 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-sale icon-md absolute-center text-dark"></i></div>
